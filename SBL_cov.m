...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Calculate the model data covariances using SBL
%
% Chang Cai 7/2/2023
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% c(nc*nc) = the model data covariance
%
%
% Input:
% y(nk,nt) = sensor data
...
function [gamma,x,w,c]=SBL_cov(y,f,nem,nd,vcs,plot_on,coup,ncf);
